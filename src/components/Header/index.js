    ...
    <header className="bg-[#FCF9F5] sticky top-0 z-[9999]">
      <Container>
        <div className="flex justify-between items-center py-8">
          ...
          />
          <nav
            className={`lg:flex lg:space-x-20 flex flex-col lg:flex-row absolute lg:static bg-white lg:bg-transparent top-[100%] left-0 z-[999] h-96 lg:h-auto w-full  justify-center items-center space-y-8 md:space-y-0 ${
              menu ? 'hidden' : ''
            }`}
          >
            <NavLink
